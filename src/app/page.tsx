...
export default function Home() {
  return (
    <main className="flex min-h-screen w-screen flex-col items-start justify-between p-5 m:p-12 overflow-hidden bg-matte-black-radial text-white">
        <div className="animate-fade-up flex flex-col items-start justify-start sm:pt-2 md:pt-24">
          ...
          <h1 className='text-4xl md:text-6xl mb-3 text-white'>Cambridge AI Reading Group</h1>
