...
export default function Home() {
  return (
    <main className="flex min-h-screen w-screen flex-col items-start justify-between p-12 overflow-hidden bg-matte-black-radial">
        <div className="animate-fade-up flex flex-col items-start justify-start pt-24">
        ...
        <div className="animate-fade-up flex flex-col items-end justify-start w-full">
          <a target="_blakn" 
            ...
            className="mb-3 w-1/3 inline-block px-6 py-3 text-white border-[1px] border-white bg-gray-900 rounded-lg hover:rounded-3xl hover:shadow-md transition-all ease-in-out 2s text-center"
          >
